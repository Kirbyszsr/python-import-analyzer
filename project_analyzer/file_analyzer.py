            ...
            if root_file.is_type("file"):
                ...
                if root_file.is_type("folder"):
                    ...
                    for file in root_file.owns:
                        has_suffix_file, child_file_node = FileAnalyzer.file_suffix_analyze(
                            suffix, file)
                        if has_suffix_file:
...
if __name__ == "__main__":
    ...
    if file_system:
        has_tree, file_system_suffix_Lib = FileAnalyzer.file_suffix_analyze(
            'jpg', file_system)
        print('lib tree:')
